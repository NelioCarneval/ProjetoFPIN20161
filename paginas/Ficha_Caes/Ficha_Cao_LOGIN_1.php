...
<html>
    ...
    <body>
        <div id="total">
            ...
            <div id="conteudo">
                <p><a class="subnav" href="../CaesParaAdocao.html">Cães para adoção</a> / <a class="subnav" href="#"><?php echo $cao_1["nome"]; ?></a></p>
                ...
                <div id="login">
                    <form method="post" action="Ficha_Cao_PROPOSTA_1.php#proposta">
