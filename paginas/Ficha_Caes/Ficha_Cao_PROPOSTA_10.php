...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo $cao_10["nome"]; ?> | Melhor Amigo</title>
        ...
        <div id="total">
            ...
            <div id="conteudo">
                ...
                <div id="ficha">
                    ...
                    <div id="dados">
                        <h2 id="nome"><?php echo $cao_10["nome"]; ?></h2>
                        <p>Gênero: <?php echo $cao_10["genero"]; ?></p>
                        <p>Idade: <?php echo $cao_10["idade"]; ?> Anos</p>
                        <p>Porte <?php echo $cao_10["porte"]; ?></p>
                    </div>
                </div>
                ...
                <div id="proposta">
                    <form method="post" action="Ficha_Cao_AGRADECIMENTO_10.php#proposta">
                        <p>Nome do Cão:<br>
                            <input type="text" name="nome-do-cao" value="<?php echo $cao_10["nome"]; ?>"></p>
