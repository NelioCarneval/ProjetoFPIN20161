...
<html>
    ...
    <body>
        <div id="total">
            ...
            <div id="conteudo">
                <p><a class="subnav" href="../CaesParaAdocao.html">Cães para adoção</a> / <a class="subnav" href="#"><?php echo $cao_3["nome"]; ?></a></p>
                ...
                <div id="proposta">
                    <form method="post" action="Ficha_Cao_AGRADECIMENTO_3.php#proposta">
                        <p>Nome do Cão:<br>
                            <input type="text" name="nome-do-cao" value="<?php echo $cao_3["nome"]; ?>"></p>
