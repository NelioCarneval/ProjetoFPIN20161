...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo $cao_9["nome"]; ?> | Melhor Amigo</title>
    ...
    <body>
        <div id="total">
            ...
            <header>
                <nav>
                    <p><a href="../CaesParaAdocao.html">Adoções</a><a href="../PaginaPadrinho.html">Apadrinhamento</a><a href="../PaginaDoacao.html">Doações</a><a href="../Voluntario_LOGIN.html">Voluntários</a><a href="../PaginaLogin.html">Entrar</a><a href="../FormularioDeCadastro2.html">Cadastre-se</a></p>
                </nav>
            </header>

            <div id="conteudo">
                <p><a class="subnav" href="../CaesParaAdocao.html">Cães para adoção</a> / <a class="subnav" href="#"><?php echo $cao_9["nome"]; ?></a></p>

                <div id="ficha">
                    <img id="fotoDestaque" src="../../img/caes/cao_09.jpg">
                    <div id="dados">
                        <h2 id="nome"><?php echo $cao_9["nome"]; ?></h2>
                        <p>Gênero: <?php echo $cao_9["genero"]; ?></p>
                        <p>Idade: <?php echo $cao_9["idade"]; ?> Anos</p>
                        <p>Porte <?php echo $cao_9["porte"]; ?></p>
                    </div>
                </div>
