...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title><?php echo $cao_6["nome"]; ?> | Melhor Amigo</title>
    ...
    <body>
        <div id="total">
            ...
            <div id="conteudo">
                <p><a class="subnav" href="../CaesParaAdocao.html">Cães para adoção</a> / <a class="subnav" href="#"><?php echo $cao_6["nome"]; ?></a></p>

                <div id="ficha">
                    <img id="fotoDestaque" src="../../img/caes/cao_06.jpg">
                    <div id="dados">
                        <h2 id="nome"><?php echo $cao_6["nome"]; ?></h2>
                        <p>Gênero: <?php echo $cao_6["genero"]; ?></p>
                        <p>Idade: <?php echo $cao_6["idade"]; ?> Anos</p>
                        <p>Porte <?php echo $cao_6["porte"]; ?></p>
                    </div>
                </div>
                ...
                <div id="proposta">
                    <form method="post" action="Ficha_Cao_AGRADECIMENTO_6.php#proposta">
                        <p>Nome do Cão:<br>
                            <input type="text" name="nome-do-cao" value="<?php echo $cao_6["nome"]; ?>"></p>
